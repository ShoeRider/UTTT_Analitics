...
public:
  ...
  //////////////////////////////////////////////////////////////////////////////
    ...
    std::string GetStats(long int Depth);
    void DisplayStats(long int Depth);
    void Search(long int Depth); //,Player* GivenPlayer
...
template <typename Game_Tp, typename Player_Tp>
std::string MCHS<Game_Tp,Player_Tp>::GetStats(long int Depth)
{
  std::string Stats;
  Stats.append(HeadNode->DisplayTree(Depth));
  Stats.append(HeadNode->DisplayStats());
  return Stats;
}

template <typename Game_Tp, typename Player_Tp>
void MCHS<Game_Tp,Player_Tp>::DisplayStats(long int Depth)
{
  std::cout << this->GetStats(Depth);
}
 ...
 */
template <typename Game_Tp, typename Player_Tp>
void MCHS<Game_Tp,Player_Tp>::Search(long int Depth)
{
